...
const EditBook = () => {
    ...
    useEffect ( () => {
        ...
        .then((response) => {
            ...
            setLoading(false);
            alert('An error happened. Check console message for more detail');
            console.log(error)
        });
    }, [])

    
    //handling book operations
    const handleEditBook = () => {
        ...
        axios 
            ...
            .catch((error) => {
                setLoading(false);
                alert('Error happened. Check console for more detail');
